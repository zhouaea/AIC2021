...
public class Worker extends MyUnit {
  ...
  boolean travelledToResource = false;
...
//      this.current = this.resourceLocations.remove(0);
//      if (bug2(uc.getLocation(), this.current)) travelledToResource = true;
//    }
//    uc.println(uc.getEnergyLeft());
  }
...
//      goToLocation(deer[0].getLocation());
      this.bug2(this.uc.getLocation(), currentDeerLocation);
    } else {
...
//      goToLocation(depositLocation);
      this.bug2(this.uc.getLocation(), depositLocation);
    }
  }
...
//    goToLocation(found_resources.get(currentFoundResourceIndex).location);
    this.bug2(this.uc.getLocation(), found_resources.get(currentFoundResourceIndex).location);
  }
